...
export default function Contact() {
  return (
    <div className="container pb-4">
      ...
      <div className="my-3 portfolio-icon-box relative mb-10">
      ...
      <form className="max-w-md mx-auto">
        ...
        <button
          type="submit"
          className=" bg-home-bg text-white font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Send Message
        </button>
      </form>
